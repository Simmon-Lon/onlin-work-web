  ...
  <div>
    <div>
      <div style="display: flex;justify-content: space-between">
        <div>
          <el-input v-model="empName" @keydown.native.enter="initEmps" clearable @clear="initEmps" :disabled="showAdvanceSearchVisible" style="width: 300px;margin-right: 10px" aria-placeholder="请输入员工名进行搜索..." prefix-icon="el-icon-search"></el-input>
          <el-button type="primary" @click="initEmps" icon="el-icon-search" :disabled="showAdvanceSearchVisible">搜索</el-button>
          <el-button type="primary" :icon="showAdvanceSearchVisible?'el-icon-arrow-up':'el-icon-arrow-down'" @click="showAdvanceSearchVisible=!showAdvanceSearchVisible">高级搜索</el-button>
        </div>
        <div>
          <el-upload
    ...
    <transition name="slide-fade">
      <div v-show="showAdvanceSearchVisible" style="border: 1px solid #409eff;border-radius: 5px;box-sizing: border-box;padding: 5px;margin: 10px 0px;">
        <el-row>
          ...
          <el-col :span="4">
            职称:
            <el-select v-model="searchValue.jobLevelId" size="mini" style="width: 150px" placeholder="职称">
              <el-option
        ...
        <el-row style="margin-top: 10px">
          <el-col :span="5">
            ...
            <el-popover
              ...
              <div slot="reference" @click="showDepView2" style="height: 26px; width: 130px;display: inline-flex;border: 1px solid #dedede;border-radius: 5px;cursor: pointer;margin-top: 3px;align-items: center;font-size: 13px;padding-left: 8px;box-sizing: border-box">
                {{inputDepName}}
              </div>
            </el-popover>
          </el-col>
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="姓名:" prop="name">
                <el-input size="mini" prefix-icon="el-icon-user" style="width: 150px" v-model="emp.name" aria-placeholder="请输入员工姓名..."></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
          ...
          <el-row>
            ...
            <el-col :span="5">
              <el-form-item label="籍贯:" prop="nativePlace">
                <el-input size="mini" style="width: 120px" v-model="emp.nativePlace" aria-placeholder="请输入籍贯..." prefix-icon="el-icon-edit"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="电子邮箱:" prop="email">
                <el-input v-model="emp.email" aria-placeholder="请输入电子邮箱..." size="mini" style="width: 150px" prefix-icon="el-icon-message"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="联系地址:" prop="address">
                <el-input v-model="emp.address" aria-placeholder="请输入地址..." size="mini" style="width:200px" prefix-icon="el-icon-position"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="所属部门:" prop="departmentId">
                <el-popover
                  ...
                  <div slot="reference" @click="showDepView" style="height: 26px; width: 150px;display: inline-flex;border: 1px solid #dedede;border-radius: 5px;cursor: pointer;margin-top: 3px;align-items: center;font-size: 13px;padding-left: 8px;box-sizing: border-box">
                    {{inputDepName}}
                  </div>
                </el-popover>
              </el-form-item>
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="工号:" prop="workID">
                <el-input disabled v-model="emp.workID" aria-placeholder="请输入工号..." prefix-icon="el-icon-edit" size="mini" style="width: 150px"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="学历:" prop="tiptopDegree">
                <el-select v-model="emp.tiptopDegree" size="mini" style="width: 150px" placeholder="职称">
                  <el-option
            ...
            <el-col :span="6">
              <el-form-item label="毕业院校:" prop="school">
                <el-input v-model="emp.school" aria-placeholder="请输入毕业院校..." size="mini" style="width: 150px" prefix-icon="el-icon-edit"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="专业名称:" prop="specialty">
                <el-input v-model="emp.specialty" aria-placeholder="请输入专业名称..." size="mini" style="width: 200px"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="身份证号码:" prop="idCard">
                <el-input style="width: 180px" prefix-icon="el-icon-postcard" v-model="emp.idCard" aria-placeholder="请输入身份证号..." size="mini"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
...
export default {
  ...
  data(){
    return{
      ...
      rules:{
        ...
        departmentId: [{required:true,message:'请输入用户名',trigger:'blur'}],
        jobLevelId: [{
  ...
  methods:{
    ...
    deleteEmp(data){
      this.$confirm('是否永久删除'+data.name+'员工?', '提示', {
