  ...
  <div>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button type="primary" @click="showAddSalaryView(scope.row)">编辑</el-button>
    ...
    <el-dialog
      ...
      <div style="display: flex;justify-content: space-around;align-items: center">
        ...
        <el-input style="width: 200px"  v-for="(value,title,index) in salary" :key="index" v-model="salary[title]" v-show="activeItemIndex==index" :placeholder="'请输入'+salaryItemName[index]+'...'"></el-input>
      </div>
