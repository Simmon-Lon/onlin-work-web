        ...
        <el-collapse-item :title="r.nameZh" :name="r.id" v-for="(r,index) in roles" :key="index">
          <el-card class="box-card">
            <div slot="header" class="clearfix">
              <span>可访问资源</span>
              <el-button @click="doDeleteRole(r)" style="float: right; padding: 3px 0;color: #FF0000FF" type="text" icon="el-icon-delete"></el-button>
            </div>
           <div>
  ...
  methods:{
    ...
    doAddRole(){
      if (this.role.name && this.role.nameZh){
        ...
        //console.log(this.role.name+this.role.nameZh);
